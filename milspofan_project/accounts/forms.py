...
# UserCreationForm for django admin panel; modified from https://gist.github.com/haxoza/7921eaf966a16ffb95a0
...
class UserCreationForm(forms.ModelForm):
    ...
    class Meta:
        model = MemberProfile
        fields = ('email', 'display_name', 'name_on_blog', 'email', 'artist_bio', 'website', 'image_url', 'hashtags')
